...
function UserLocation() {
    ...
    let [building_name, setbuilding_name] = useState("")
    ...
    let data = {landmark,building_name,house_number,city,state,country,pincode,address_type}
    ...
    return (
        <div className='UserLocation'>
            <form onSubmit={addAdress} action="">
                ...
                <label htmlFor="">Building Name </label><input type="text" placeholder='Enter the Building Name ' required value={building_name} onChange={(e) => { setbuilding_name(e.target.value) }} />
